...
const FeaturesHome = props => {
  return (
    ...
    <div className="bg-white py-20 relative md:py-28 lg:py-[7.5rem]">
      <div
        className="grid gap-y-14 container justify-center md:gap-y-20
        lg:grid-flow-col lg:gap-x-[1.875rem]"
      >
        <Feature
          image="responsive"
