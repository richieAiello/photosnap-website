...
const Plan = ({ state, plans, secondary, heading, text, prices }) => {
  return (
    ...
    >
      ...
      <p className="opacity-60 mb-10 md:text-left md:row-start-2 md:mb-8">
        {text}
      </p>
      <p className="font-bold text-[2.5rem] leading-[3rem] tracking-[4.17px] md:text-right">
        {state === plans[0] ? prices[0] : prices[1]}
      </p>
      <p className="opacity-60 mb-10 md:text-right md:mr-2">
